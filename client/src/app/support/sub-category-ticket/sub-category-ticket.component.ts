...
@Component({
  templateUrl: './sub-category-ticket.component.html'
})
export class SubCategoryTicketComponent extends BaseComponent implements OnInit {
  ...
  getRecords() {
    this.recipeService.getSubcategoriesTicket({
        isLoadRecipe: false,
  ...
  saveDetails(id: any) {
    this.showLoading();
      this.recipeService.saveSubcategoryTicket({
          id: id ? id : this.id,
          name: this.name,
